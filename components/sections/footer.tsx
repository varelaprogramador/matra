    ...
    <footer className="border-t border-white/5 bg-black">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 sm:py-16 lg:px-8">
        ...
        <div className="mb-10 sm:mb-16">
          <h4 className="mb-4 sm:mb-6 text-center text-xs sm:text-sm font-semibold uppercase tracking-wider text-white/60">
            Nossa Localizacao
          </h4>
          ...
          <p className="mt-3 sm:mt-4 text-center text-xs sm:text-sm text-white/40">
        ...
        <div className="grid gap-8 sm:gap-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
          ...
          {/* Services Links */}
          <div>
            <h4 className="mb-3 sm:mb-4 text-xs sm:text-sm font-semibold uppercase tracking-wider text-white/60">
              Servicos
            </h4>
            <ul className="space-y-2 sm:space-y-3">
              {links.services.map((link) => (
                <li key={link.label}>
                  <motion.a
                    href={link.href}
                    className="text-xs sm:text-sm text-white/40 transition-colors hover:text-white"
                    whileHover={{ x: 2 }}
                  >
                    {link.label}
                  </motion.a>
        ...
        <div className="mt-10 sm:mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-6 sm:pt-8 md:flex-row">
          <p className="text-xs sm:text-sm text-white/30 text-center md:text-left">
