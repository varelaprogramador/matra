...
export function Differentials() {
  return (
    <section className="relative bg-black py-16 flex items-center min-h-screen">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <StaggerContainer staggerDelay={0.1} className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {differentials.map((diff) => (
            ...
            >
              <motion.div
                className="relative h-full overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-all duration-300"
                whileHover={{
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-shrink-0 rounded-xl border border-white/10 bg-white/5 p-3 text-white">
                      {diff.icon}
                    </div>
                    <div className="text-right">
                      ...
                      <div className="text-xs text-white/40">{diff.metricLabel}</div>
                    </div>
                  </div>
